            ...
            <>
              ...
              {activeTab === 'browser' && (
                <div className="space-y-5">
                  ...
                  <Field label={t('settings.browser.defaultZoom')}>
                    <select
                      value={Number(values.default_browser_zoom) || 67}
                      onChange={(event) => setValue('default_browser_zoom', parseInt(event.target.value, 10) || 67)}
                    ...
                    <p className="mt-1 text-xs text-[#6f7d90]">{t('settings.browser.defaultZoomHint')}</p>
                  </Field>
              ...
              {activeTab === 'automation' && (
                <div className="space-y-5">
                  ...
                  <label className="flex items-center gap-3 text-sm text-[#c7d0dc]">
                    <input
                      type="checkbox"
                      checked={values['execution_browser_lock'] !== false}
                      onChange={(event) => setValue('execution_browser_lock', event.target.checked)}
                      className="h-4 w-4 accent-[#2f80ed]"
                    />
                    <span>
                      {t('settings.automation.executionBrowserLock')}
                      <span className="mt-0.5 block text-xs text-[#6f7d90]">
                        {t('settings.automation.executionBrowserLockHint')}
                      </span>
                    </span>
                  </label>
